...
{
	public ConcretePushNotification(NotificationType notificationType, String title, String description, boolean fromActivity)
	{
	...
	public void process(Context context)
	{
		...
		if (isAppInForeground()) //The app is open
		{
			//Something
