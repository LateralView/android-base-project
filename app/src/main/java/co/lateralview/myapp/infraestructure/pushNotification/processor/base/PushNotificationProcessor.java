...
public abstract class PushNotificationProcessor implements Serializable
{
	...
	public PushNotificationProcessor(NotificationType notificationType, String title, String description, boolean appRunning)
	{
	...
	public static PushNotificationProcessor create(NotificationType notificationType, String title, String message, boolean appRunning)
	{
	...
	protected void sendNotification(Context context, Intent intent)
	{
		...
		NotificationCompat.Builder notificationBuilder = new NotificationCompat.Builder(context)
				...
				.setContentTitle(mTitle != null && !mTitle.isEmpty() ? mTitle : context.getString(R.string.app_name))
