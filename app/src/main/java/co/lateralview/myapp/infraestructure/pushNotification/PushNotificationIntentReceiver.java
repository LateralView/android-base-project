...
public class PushNotificationIntentReceiver extends WakefulBroadcastReceiver
{
	...
	public void onReceive(Context context, Intent intent)
	{
		...
		PushNotificationProcessor concretePushNotification = PushNotificationProcessor.create(NotificationType.fromString(extras.getString("type").toUpperCase()),
				extras.getString("title"), extras.getString("message"), MyApp.isApplicationRunning());
