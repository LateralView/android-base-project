...
public class SnackBarHelper
{
	...
	public static Snackbar createSnackBar(View view, SnackBarData snackBar)
	{
		...
		return createSnackBar(view, description, action, snackBarType.getDuration(), snackBarType.getBackgroundColor(), snackBar.getSnackBarListener());
	}

	public static Snackbar createSnackBar(Activity activity, String description, String action, int duration, int backgroundColor, final ISnackBarHandler snackBarHandler)
	{
		return createSnackBar(getActivityViewContainer(activity), description, action, duration, backgroundColor, snackBarHandler);
	}

	public static Snackbar createSnackBar(View view, String description, String action, int duration, int backgroundColor, final ISnackBarHandler snackBarHandler)
	{
		...
		{
			snackBarView.setBackgroundColor(UIUtils.getColorFromRes(view.getContext(), backgroundColor));
		}
