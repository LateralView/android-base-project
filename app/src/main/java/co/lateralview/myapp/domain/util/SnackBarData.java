...
public class SnackBarData implements Serializable
{
	public enum SnackBarType implements Serializable
	{
		...
		CONNECTION_ERROR(R.string.snackBarConnectionError_description, R.string.snackBarConnectionError_action, R.color.red, Snackbar.LENGTH_INDEFINITE),
		NO_INTERNET(R.string.snackBarNoInternet_description, -1, R.color.red, Snackbar.LENGTH_INDEFINITE);
	...
	public SnackBarData(SnackBarType mSnackBarType, SnackBarHelper.ISnackBarHandler mSnackBarListener)
	{
